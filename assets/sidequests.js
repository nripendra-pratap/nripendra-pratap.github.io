...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (note) {
    ...
    note.textContent = !n
      ? "📝 The first dispatch is being written — check back soon."
      : n === 1
        ? "📝 First dispatch is live — more detours to come."
        : `📝 ${n} dispatches live — more detours to come.`;
  }
